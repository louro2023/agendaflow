...
import { Search, Calendar, Clock, User, CheckCircle2, AlertCircle, XCircle, Filter } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Visualize todos os eventos agendados no sistema</p>
        </div>
          ...
          {filteredEvents.length > 0 ? (
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">
                {searchTerm || statusFilter !== 'all' ? 'Tente ajustar os filtros' : 'Não há eventos agendados no sistema'}
              </p>
            </div>
          )}
        </div>
